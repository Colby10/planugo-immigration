                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        ...
                        <div className="text-box">
                            <h2 className="wow slideInRight" data-wow-duration="2s">Immigration by bdvbvdv</h2>
                    ...
                    <div className="carousel-item">
                        ...
                        <div class="text-box">
                            ...
                            <p className="wow fadeInDown" data-wow-duration="4s">
                                Une conseillère en d'immigration Canadien qui donne l'ascascasca aux personnes, aux 
                                familles et aux entreprises de asca leur rêve d'établacsacissement au Canada. 
                            </p>
                        </div>
                    </div>
                </div>
