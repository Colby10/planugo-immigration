...
export default function ProcedureTerminer() {
    ...
    useEffect(() => {
        const q = query(collection(db, 'Postulant'), where("statut", "==", "Terminer"), orderBy('created', 'desc'))
            ...
            <div className="wrap-Home-Dashboard">
                <div className="table">
                    <div className="table_header">
                        <h1>{postulant.length} Procedure terminer</h1>
                        <form action="/" >
