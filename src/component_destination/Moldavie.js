                    ...
                    <div className="services">
                        <div className="row g-4">
                            <ServiceCanada 
                                ...
                                texte1="Que vous offre le service d'accompagnement en Moldavie ?"
                                href="/"
                                lire="Lire plus"
                                icon={<i className="fa-regular fa-circle-right"></i>}
                            />
                            <ServiceCanada 
                                ...
                                texte1="Obtenir des avantages en étudiant en Moldavie "
                                href="/"
                                lire="Lire plus"
                                icon={<i className="fa-regular fa-circle-right"></i>}
                            />
                            <ServiceCanada 
                                ...
                                texte1="Comment fonctionnent les permis de travail en Moldavie "
                                href="/"
                                lire="Lire plus"
                                icon={<i className="fa-regular fa-circle-right"></i>}
                            />
